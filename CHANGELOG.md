...
## v4.1.3
Удалены лишние слова из безопасного словаря:
- `впечатлёна`;
- `впечатлёно`;
- `впечатлёны`;

## v4.1.2
Фикс некорректной ёфикации в некоторых случаях.

## v4.1.1
Правки по сборке.

## v4.1.0
- Фикс ёфикации при троеточии.
- Отдельные сборки со встроенными словарями для удобного использования в браузере, см. `README.md`.
